This python program simulates rolling two dice a user-specified number of times. It displays the result of each roll, counts how many times the total is 6 or 7, and prints summary statistics at the end.
